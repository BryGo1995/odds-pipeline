...
def test_normalize_name_strips_accents():
    from nba.plugins.transformers.player_name_resolution import normalize_name
...
def test_resolve_player_ids_inserts_high_confidence_match():
    ...
    with patch("nba.plugins.transformers.player_name_resolution.send_slack_message") as mock_slack:
